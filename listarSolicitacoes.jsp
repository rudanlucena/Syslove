...
<html>
	...
	<body>
		...
		<nav class="navbar navbar-inverse">
		  <div class="container-fluid">
		    ...
		    <div class="navbar-header">
		    	<a class="navbar-brand" href="#">Solicitações Amizade</a>		      
		    </div>
		  </div>
		</nav>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<myTags:ListarSolicitacoes email="${sessionScope.email}" />

					<c:choose>
						<c:when test="${solicitacoes == null}">
							<div class="alert alert-warning">
							  <strong>Você não possui solicitações de amizade!</strong>
							</div>
						</c:when>
						<c:otherwise>
							<div class="row">			
									        ...
									        <div class="caption">
									            ...
									            <div class="actions">
													...
													<form action="frontController" method="post" class="formAction">
														<input type="hidden" name="action" value="RejeitarSolicitacaoAmizade">
													...
													<form action="frontController" method="post" class="formAction">
														...
														<input type="hidden" name="remetente" value="${usuario.email}">
														<button type="submit" title="Confirmar" class="btn btn-actions btn-sm"><span class="glyphicon glyphicon-ok"></span></button>
													</form>		
